 ...
 */
 ...
 $max_upload_size = radio_station_convert_filesize(radio_station_file_upload_max_size());
 ?>
    ...
    <div class="seven wide column container">
      <div class="ui segment">
        ...
        <form class="ui form" method="POST" action="/wp-admin/admin.php?page=import-export-shows" enctype="multipart/form-data">
          ...
          <button class="ui left floating button" type="submit" onclick="radio_enable_spinner('import')"><?php _e('Import', 'radio-station') ?></button>
    ...
    <div class="seven wide column container">
      <div class="ui segment">
        ...
        <form class="ui form" method="POST" action="/wp-admin/admin.php?page=import-export-shows" enctype="multipart/form-data">
          ...
          <button class="ui left floating button" type="submit" onclick="radio_enable_spinner('export')"><?php _e('Export', 'radio-station') ?></button>
        </form>
