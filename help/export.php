...
When the system is done processing, you'll see a message box with links to download the files. One or two files are generated
...
image archive is a zip file of all the images each show references. File size is shown next to each link.
</p>
<p>
